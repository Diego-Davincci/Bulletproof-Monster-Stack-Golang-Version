...
- Controller Layer 👉 Handles incoming requests, validate data input, generate appropiate responses
- Service Layer 👉 Handles all bussines logic
- Repository Layer 👉 Handles the data layer by accessing the DB
